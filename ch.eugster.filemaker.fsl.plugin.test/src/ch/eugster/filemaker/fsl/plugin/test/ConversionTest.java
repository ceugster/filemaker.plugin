...
public class ConversionTest
{
	...
	public void testParametersOK() throws SQLException, IOException
	{
		...
		assertNotNull(resultNode.get(Parameter.SOURCE_XML.key()));
		assertEquals(xml, resultNode.get(Parameter.SOURCE_XML.key()).asText());
		System.out.println(resultNode.get(Parameter.SOURCE_XML.key()).asText());
		assertNotNull(resultNode.get(Parameter.TARGET_JSON.key()));
		assertEquals(
	...
	public void testParametersError() throws SQLException, IOException
	{
		...
		assertNotNull(target.get(Parameter.SOURCE_XML.key()));
		assertEquals(filename, target.get(Parameter.SOURCE_XML.key()).asText());
